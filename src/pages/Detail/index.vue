        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spu in spuSaleAttrList" :key="spu.id">
                ...
                <dd
                  ...
                  v-for="attr in spu.spuSaleAttrValueList"
                  :key="attr.id"
                  @click="changeActive(attr, spu.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 加入购物车，在路由跳转之前，发请求将产品信息通知服务器进行存储 -->
